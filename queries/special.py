...
_POLITICS: AnswerType = {
    "answer": "Ég er ekki ekki pólitísk, enda ekki enn komin með atkvæðisrétt."
}
...
_SPECIAL_QUERIES: Dict[str, Union[AnswerType, AnswerCallable]] = {
    ...
    "veistu ekkert eða": {"answer": "Ég veit nú eitt og annað. Spurðu mig!"},
    "veistu ekkert eða hvað": {"answer": "Ég veit nú eitt og annað. Spurðu mig!"},
    ...
    "geturðu hlegið": {"answer": "Já. Hahaha."},
    "getur þú hlegið": {"answer": "Já. Hahaha."},
    # What's fun?
