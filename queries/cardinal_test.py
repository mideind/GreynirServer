...
QUERY_NONTERMINALS = {"QCardinal"}

# The context-free grammar for the queries recognized by this plug-in module
GRAMMAR = read_grammar_file("cardinal_test")


def QCardinal(node: Node, params: QueryStateDict, result: Result) -> None:
    result.qtype = _CARDINAL_QTYPE
...
def sentence(state: QueryStateDict, result: Result) -> None:
    ...
    print("I am " + str(result.cardinals[0]) + ".")
    val = str(result.cardinals[0])
    try:
